...
run_sheet_actions = {
    ...
    "Round reset clears active card and recap state.": "Create an active round with recap content, run Runde zuruecksetzen, and confirm the active card/recap clear.",
    "Score reset clears player score totals without removing players.": "Create player scores, run Scores zuruecksetzen, and confirm players remain with cleared totals.",
    "Player reset clears the player panel.": "Create players, run Spieler loeschen, and confirm the player panel is empty.",
    "Age/safety reset returns to the first-run gate with start disabled until confirmations are accepted.": "Run Alters-/Sicherheitshinweis zuruecksetzen and confirm the app returns to first-run with start disabled until confirmations are checked.",
