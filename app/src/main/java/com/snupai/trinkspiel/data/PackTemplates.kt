...
object PackTemplates {
    val all = listOf(
        template(
            ...
            description = "Sanfter Mix fuer Hausrunden mit Wahrheiten, Mini-Spielen und kleinen Regeln.",
            recommendedMode = GameMode.CHILL,
            recommendedIntensity = DrinkIntensity.LOW,
            cards = listOf(
                draft("Vorlage: Harmlose Wahrheit ueber den heutigen Abend.", 1, CardCategory.TRUTH),
                ...
                draft("Vorlage: Kleine Regel bis zur naechsten Karte.", 1, CardCategory.RULE),
                ...
                draft("Vorlage: Duell fuer zwei Spieler, Verlierer trinkt 1.", 1, CardCategory.DUEL),
        ...
        template(
            ...
            description = "Mehr Energie, aber weiterhin kurze Karten fuer Musik, Outfits und Start-in-den-Abend.",
            ...
            cards = listOf(
                ...
                draft("Vorlage: Verteile 2 Schlucke mit kurzer Begruendung.", 2, CardCategory.CHALLENGE),
                ...
                draft("Vorlage: Wahrheit ueber einen Song, Look oder Plan.", 1, CardCategory.TRUTH),
                ...
                draft("Vorlage: Pausenkarte fuer Wasser, Essen oder frische Luft.", 1, CardCategory.EVERYONE),
            ),
        ),
        template(
            id = "couples_soft",
            ...
            cards = listOf(
                ...
                draft("Vorlage: Alle stimmen ueber eine sympathische Eigenschaft ab.", 1, CardCategory.EVERYONE),
                draft("Vorlage: Team-Aufgabe fuer zwei Spieler am Platz.", 1, CardCategory.CHALLENGE),
                draft("Vorlage: Wahrheit ueber Dating, Freundschaft oder Alltag.", 1, CardCategory.TRUTH),
